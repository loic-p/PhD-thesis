...
\input{notations.tex} % Include mathematical notations
...
\input{agdanotations.tex} % Agda notations. 
...
% 	\textit{Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus convallis diam nec dolor sagittis,
% 	nec euismod ligula sollicitudin.}
% }
...
\input{chapters/intro_french.tex}
...
% \input{chapters/intensional.tex}
\input{chapters/observational.tex}
\input{chapters/metatheory.tex}
\input{chapters/inductives.tex}

\pagelayout{wide} % No margins
\addpart{The Univalent Equality}
\pagelayout{margin} % Restore margins

% \input{chapters/hott.tex}
\input{chapters/prefascist.tex}
\input{chapters/cubical_model.tex}
