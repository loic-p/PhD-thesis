...
% 
\sideremark{The developments
  can be found in the \texttt{agda/cubical} library located
  at:\\ \url{https://github.com/agda/cubical}}
% 
...
\sideremark{The homogeneous path types are written using a triple equality
  symbol, following the convention of \CubicalAgda. The reader should be
  careful to not get confused with the inductive equality type of \cref{ch:prefascist}, 
  or the definitional equality of \cref{ch:observational}.}
% 
