...
The syntax of the sorts, contexts, terms and types of the core system is
...
Now, the exact meaning of \MLTT is left 

This theorem is intentionally a bit vague about the meaning of \MLTT (hence 
the ``pseudo'' part). 

But depending on how we define it, there might be more inductive types in 
\MLTT
