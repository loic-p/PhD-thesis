...
\paragraph*{Martin-Löf Type Theory}
% 
...
theorems that can be stated in \( \mathcal{T} \)} over \MLTT, as it becomes 
...
\begin{proof}
\sidecitet{hofmann95} proved that \ETT is conservative over \MLTT + UIP + 
