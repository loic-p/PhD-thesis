...
The aim of this chapter is to work toward an extension of the prefascist translation 
that supports the univalence axiom.
%  
Our strategy is to enrich it with a notion of \emph{fibration structure}, following the model 
of Cohen \etal in cubical sets~\cite{CCHM}.
% 
Such a translation would provide a new way to compute with the univalence axiom.

In \cref{sec:cubical_sets}, we give a detailed overview of cubical presheaves 
and fibration structures. 
% 
...
\begin{definition}
    ...
    \begin{itemize}
        \item the lid matches the top of the open box: 
