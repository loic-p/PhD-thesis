...
% The aim of this chapter is to work toward an extension of the prefascist 
% translation of Pédrot that supports the univalence axiom.
% %  
% Our strategy is to use \emph{cubical sets} equipped with a notion of 
% \emph{fibration structure}, following the model of Cohen \etal~\cite{CCHM}.
% % 
% Such a translation would provide a novel way to compute with the univalence axiom.
...
cubical sets}~\sidecite{BezemCoquandHuber14}.
% 
This conundrum has been solved by the introduction of cubical type 
theories~\sidecite{CCHM,ABCFHL}, which provide an axiom-free univalent system by reifying 
...
Consequently, we need to define the category of cubes as a strict category on
...
% 
We want to extend this notion of fibration structure to dependent prefascist
types, which means that we need to build a universe of \emph{CCHM-fibrant} 
prefascist types. 
...
the interpretation of \( \Gamma \) to \func{fibrantType}, and
...
The natural numbers are interpreted as a constant prefascist, whose type of
...
Compare it with a translation into cubical type theory

Talk about funext somewhere