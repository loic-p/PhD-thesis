...
rule~\nameref{infrule:cast-refl-plus} with reduction is not a resounding 
success.
% 
...
% 
Just like rule~\nameref{infrule:cast-refl-plus}, the \( \eta \)-equality rule 
...
and to handle rule~\nameref{infrule:cast-refl-plus} during conversion checking.
% 
