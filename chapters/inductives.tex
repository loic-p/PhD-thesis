...
Note that we are now using two indices in the type \( \Heteq{t}{A}{u}{B} \), 
...
\begin{mathpar}
  \inferrule[Heterogeneous-Transport-\( \sProp \)]
		{%\tytm{\Gamma}{A}{\Type_i}
    \tytmannotated{\Gamma}{t}{A}{\Type_i}
    \\ \tytm{\extctx[x]{\Gamma}{A}}{B}{\sProp} 
    \\ \tytmannotated{\Gamma}{u}{\subst[x]{B}{t}}{\sProp}
    \\ \tytmannotated{\Gamma}{t'}{A}{\Type_i}
    \\ \tytmannotated{\Gamma}{e}{\Heteq{t}{A}{t'}{A}}{\sProp}}
  {\tytmannotated{\Gamma}{\hettransport{A}{t}{B}{u}{A}{t'}{e}}{\subst[x]{B}{t'}}{\sProp}}
\end{mathpar}
\begin{mathpar}
...
% 
\begin{mathpar}
  \inferrule[Heterogeneous-Eq-Fun]{
    \tytmannotated{\Gamma}{f}{\Depfunannotated{A}{B}{}{\Type_i}{\Type_j}}{\Type_{\mathrm{max}(i,j)}}
    \\ \tytmannotated{\Gamma}{g}{\Depfunannotated{A'}{B'}{}{\Type_i}{\Type_j}}{\Type_{\mathrm{max}(i,j)}}}
			{\redmultiline{\Gamma}{\Heteq{f}{\Pi A B}{g}{\Pi A' B'}}
        {\Pi (t : A)\ (u : A')\ .\ \Fun{(\Heteq{t}{A}{u}{A'})}{(\Heteq{f\ t}{B[t]}{g\ u}{B'[u]})}}{\sProp}}
\end{mathpar}

Remark that contrary to the homogeneous rule \nameref{inferrule:eq-fun}, we do 
