...
\sideremark{If necessary, we can still use dependent sums to pack multiple 
  indices or parameters in this definition.}
\[
\begin{array}{l}
...
To be well-formed, this definition is subject to the usual strict positivity 
...
universe of propositions from \SetoidCC, and \( \Prop \) is the proof-\emph{relevant}
...
propositions. 
% 
Then, we extend the \( \castName \) operaator to work with proof-relevant propositions.
% 
...
\begin{theorem}
  ...
  propositions \( \Prop \), then conversion becomes undecidable.
\end{theorem}
