...
When we consider theories with an unbounded hierarchy of universes, we get that
...
willing to accept \SetoidTT as a new foundation of mathematics would
probably be more inclined to use it if they knew that any theorem they
proved in \SetoidTT is also true for classical set theory.
%
