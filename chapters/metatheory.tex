...
rules by collecting the well-formedness hypotheses in the reducibility predicates --
but we are not, so we will construct our model using more verbose inference rules.
% 
