...
\newcommand{\CIC}{\ensuremath{\mathsf{pCIC}}\xspace}
\newcommand{\MLTT}{\ensuremath{\mathsf{MLTT}}\xspace}
\newcommand{\MLTTW}{\ensuremath{\mathsf{MLTT}^\mathsf{W}}\xspace}
...
\newcommand{\HoTTminus}{\ensuremath{\mathsf{HoTT}^\mathrm{pf}}\xspace}
\newcommand{\SetoidTT}{\ensuremath{\mathsf{TT}^\mathrm{obs}}\xspace}
\newcommand{\SetoidCC}{\ensuremath{\mathsf{CC}^\mathrm{obs}}\xspace}
\newcommand{\SetoidCCtitle}{{\textsf{CC}\textsuperscript{obs}}}
\newcommand{\SetoidCCW}{\ensuremath{\mathsf{CC}^{\mathrm{obs}, \mathsf{W}}}\xspace}
...
\def\CubicalAgda{\textsc{Cubical} \textsc{Agda}\xspace}
...
\newcommand{\varProp}{\mathsf{Prop}}
\newcommand{\sProp}{\Omega}
\newcommand{\varsProp}{\mathsf{sProp}}
\newcommand{\hProp}{\oblset{hProp}}

\newcommand{\Type}{\mathcal{U}}
\newcommand{\varType}{\mathsf{Type}}
\newcommand{\varSet}{\mathsf{Set}}
...
\newcommand\metaop[1]{{\color{RoyalBlue}{\mathsf{#1}}}}

\newcommand{\Nat}{\mathbb{N}}
\newcommand{\Natprop}{\mathbb{N}_{\mathsf{p}}}
...
\newcommand{\Acc}{\metaop{Acc}}
\newcommand{\accintro}{\metaop{Acc{-}intro}}
\newcommand{\accelim}{\metaop{Acc{-}elim}}
...
\newcommand{\quorec}[4]{\metaop{Q\mathsf{-}elim}(#1,#2,#3,#4)}
...
\newcommand{\Indeq}[3]{{#2 =_{#1} #3}}
\newcommand{\indrefl}[1]{\mathsf{refl}_{#1}}
\newcommand{\indJ}[6]{\mathsf{J}(#1,#2,#3,#4,#5,#6)}

\newcommand{\Boxt}[1]{\square{#1}}
\newcommand{\boxt}[1]{\diamond{#1}}
\newcommand{\unboxt}[1]{\metaop{\Box\mathsf{-elim}}(#1)}
...
\newcommand{\Heteq}[4]{#1~{{}_{#2}\!\!\sim_{#4}}~#3}
...
\newcommand{\hettransport}[7]{\transportName(#1,#2,#3,#4,#5,#6,#7)}
\newcommand{\castreflName}{\metaop{castrefl}}
\newcommand{\castrefl}[2]{\castreflName(#1,#2)}

\newcommand{\Empty}{\bot}
\newcommand{\Emptyprop}{\bot_{\mathsf{p}}}
\newcommand{\emptyrec}[2]{{\color{RoyalBlue}\bot}\metaop{-elim}({#1}, {#2})}
\newcommand{\emptyrecName}{{\color{RoyalBlue}\bot}\metaop{-elim}}
...
\newcommand{\squash}[1]{| #1 |}
\newcommand{\unsquash}[3]{\metaop{\mathsf{S}\mathsf{-elim}}(#1,#2,#3)}
...
\newcommand\dashEco{\vdash_{e}}

\newcommand{\wfctx}[2][]{#1 \vdash #2}
\newcommand{\tyty}[3][]{#1 #2 \vdash #3}
\newcommand{\tytm}[4][]{#1 #2 \vdash #3 : #4}
\newcommand{\tytmPara}[4][]{#1 #2 \dashPar #3 : #4}
\newcommand{\tytmEco}[4][]{#1 #2 \dashEco #3 : #4}
\newcommand{\tm}[2]{#1 : #2}
\newcommand{\tytms}{\tytm}
% \newcommand{\eqeq}[2]{#1 \equiv abd #2}
...
\newcommand{\tytmEcoannotated}[5][]{#1 #2 \dashEco \tmannotated{#3}{#4}{#5}}
...
\newcommand{\eqtmEcoannotated}[6][]{#1 #2 \dashEco #3 \equiv #4 : #5 : #6}
\newcommand{\redannotated}[6][]{#1 #2 \vdash #3 \Rightarrow #4 : #5 : #6}
...
\newcommand{\castannotated}[5]{\mathsf{cast}^{#5}(#1,#2,#3,#4)}
...
\newcommand{\Rsigma}{\AgdaCon{R}_{\textcolor{AgdaInductiveConstructor} \Sigma}}
\newcommand{\Rbox}{\AgdaCon{R}_{\textcolor{AgdaInductiveConstructor} \Box}}
\newcommand{\Rforall}{\AgdaCon{R}_{\textcolor{AgdaInductiveConstructor} \Pi \mathsf{\textcolor{AgdaInductiveConstructor} i}}}
\newcommand{\Rexists}{\AgdaCon{R}_{\textcolor{AgdaInductiveConstructor} \exists}}
\newcommand{\Rnat}{\AgdaCon{R}_{\AgdaCon{N}}}
\newcommand{\RW}{\AgdaCon{R}_{\AgdaCon{W}}}
\newcommand{\Rquo}{\AgdaCon{R}_{\AgdaCon{Q}}}
\newcommand{\Rid}{\AgdaCon{R}_{\AgdaCon{Id}}}
...
\newcommand{\tytyReco}[4]{#2 \Vdash_{#1} #3}
\newcommand{\tytmReco}[5]{#2 \Vdash_{#1} #3 : #4}
\newcommand{\eqtmReco}[6]{#2 \Vdash_{#1} #3 \equiv #4 : #5}
\newcommand{\eqtyReco}[5]{#2 \Vdash_{#1} #3 \equiv #4}

\newcommand{\nattmR}[2]{#1 \Vdash_{\mathbb{N}\mathsf{t}}\ {#2}}
\newcommand{\nateqR}[3]{#1 \Vdash_{\mathbb{N}\mathsf{t}=}\ {#2} \equiv {#3}}
\newcommand{\quotmR}[2]{#1 \Vdash_{\mathsf{Q}\mathsf{t}}\ {#2}}
\newcommand{\quoeqR}[3]{#1 \Vdash_{\mathsf{Q}\mathsf{t}=}\ {#2} \equiv {#3}}
\newcommand{\boxtmR}[2]{#1 \Vdash_{\Box\mathsf{t}}\ {#2}}
\newcommand{\boxeqR}[3]{#1 \Vdash_{\Box\mathsf{t}=}\ {#2} \equiv {#3}}
\newcommand{\idtmR}[2]{#1 \Vdash_{\mathsf{Id}\mathsf{t}}\ {#2}}
\newcommand{\ideqR}[3]{#1 \Vdash_{\mathsf{Id}\mathsf{t}=}\ {#2} \equiv {#3}}

\newcommand{\ctxV}[1]{{\Vdash^v #1}}
\newcommand{\tytyV}[4]{#2 \Vdash^v_{#1} #3 : #4}
\newcommand{\tytmV}[5]{#2 \Vdash^v_{#1} #3 : #4 : #5}
\newcommand{\eqtyV}[5]{#2 \Vdash^v_{#1} #3 \equiv #4 : #5}
\newcommand{\eqtmV}[6]{#2 \Vdash^v_{#1} #3 \equiv #4 : #5 : #6}
\newcommand{\substV}[3]{#1 \Vdash^s #2 : #3}
\newcommand{\eqsubstV}[4]{#1 \Vdash^s #2 \equiv #3 : #4}

\newcommand{\emptyctxV}{{\textcolor{AgdaInductiveConstructor} \varepsilon}}
\newcommand{\extctxVname}{\textcolor{AgdaInductiveConstructor}{\_ , \_ }}
...
\newcommand{\codesigma}{\mathsf{c}_{\Sigma}}
\newcommand{\codebox}{\mathsf{c}_{\Box}}
\newcommand{\codequo}{\mathsf{c}_\mathsf{Q}}
\newcommand{\codeid}{\mathsf{c}_\mathsf{Id}}
...
\newcommand{\Upred}{\mathbf{U}^{\varepsilon}}
